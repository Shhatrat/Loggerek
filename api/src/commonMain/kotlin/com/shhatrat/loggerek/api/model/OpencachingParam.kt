...
sealed class OpencachingParam(
    val apiKey: String,
) {
    companion object {
        fun parseForApi(params: Collection<OpencachingParam>): String =
            params.joinToString(separator = "%7C", prefix = "", postfix = "") { it.apiKey }
    ...
    sealed class Geocache(
        ...
        companion object {
            ...
            const val GEOCACHE_API_USER_LOGS_ONLY = "latest_logs"
            const val GEOCACHE_API_LATEST_LOGS = "latest_logs"
        ...
        data object API_USER_LOGS_ONLY : Geocache(GEOCACHE_API_USER_LOGS_ONLY)
    }
}
